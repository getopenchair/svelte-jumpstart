...
// (23:2) <Route path="/privacy-policy" let:params>
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(23:2) <Route path=\\\"/privacy-policy\\\" let:params>",
		ctx
	});
...
// (26:2) <Route path="/terms-of-service" let:params>
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(26:2) <Route path=\\\"/terms-of-service\\\" let:params>",
		ctx
	});
...
const Landing = register({ loader: () => import('./Landing-6716b287.js') });

const TermsOfService = register({
	loader: () => import('./TermsOfService-db03f594.js')
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-4c7c4cf4.js')
});
