...
const Landing = register({
	loader: () => import('./Landing-54874d8f.js'),
	resolve: () => require.resolve("./Landing.svelte")
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-0e6e86fb.js'),
	resolve: () => require.resolve("./TermsOfService.svelte")
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-602b8e70.js'),
	resolve: () => require.resolve("./PrivacyPolicy.svelte")
});
