...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(p, file$1, 43, 4, 1046);
...
const Landing = register({
	loader: () => import('./Landing-e8de6b63.js'),
	resolve: () => import('./Landing-e8de6b63.js')
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-1a7ea30f.js'),
	resolve: () => import('./TermsOfService-1a7ea30f.js')
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-fc222eec.js'),
	resolve: () => import('./PrivacyPolicy-fc222eec.js')
});
...
//# sourceMappingURL=main-9f7831b3.js.map
