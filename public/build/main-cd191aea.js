...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(p, file$1, 43, 4, 1039);
...
const Landing = register({
	loader: () => import('./Landing-9a750d74.js'),
	resolve: () => import('./Landing-9a750d74.js')
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-d23c1c12.js'),
	resolve: () => import('./TermsOfService-d23c1c12.js')
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-1513eac5.js'),
	resolve: () => import('./PrivacyPolicy-1513eac5.js')
});
...
//# sourceMappingURL=main-cd191aea.js.map
