...
/* node_modules/svelte-loadable/Loadable.svelte generated by Svelte v3.20.1 */
...
// (33:4) <Route path="/privacy-policy" let:params>
function create_default_slot_3(ctx) {
	let current;

	const loadable = new Loadable({
			props: { loader: PrivacyPolicy },
			$$inline: true
		});
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(33:4) <Route path=\\\"/privacy-policy\\\" let:params>",
		ctx
	});
...
// (36:4) <Route path="/terms-of-service" let:params>
function create_default_slot_2(ctx) {
	let current;

	const loadable = new Loadable({
			props: { loader: TermsOfService },
			$$inline: true
		});
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(36:4) <Route path=\\\"/terms-of-service\\\" let:params>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", "Site-content svelte-qcumez");
			add_location(div0, file$1, 31, 2, 716);
			add_location(p, file$1, 43, 4, 1054);
			attr_dev(div1, "class", "Footer");
			add_location(div1, file$1, 42, 2, 1029);
		},
		m: function mount(target, anchor) {
...
const Landing = register({
	loader: () => import('./Landing-a77db508.js'),
	resolve: () => import('./Landing-a77db508.js')
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-9815a9c7.js'),
	resolve: () => import('./TermsOfService-9815a9c7.js')
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-b5b4d26e.js'),
	resolve: () => import('./PrivacyPolicy-b5b4d26e.js')
});
...
export { SvelteComponentDev as S, app as a, add_location as b, insert_dev as c, dispatch_dev as d, element as e, append_dev as f, set_data_dev as g, detach_dev as h, init as i, listen_dev as l, noop as n, safe_not_equal as s, text as t, validate_slots as v };
//# sourceMappingURL=main-2ae8e3a1.js.map
