...
const Landing = register({
	loader: () => import('./Landing-07b610d0.js'),
	resolve: require => require.resolve("./Landing.svelte")
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-7bea879b.js'),
	resolve: require => require.resolve("./TermsOfService.svelte")
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-0a8ede31.js'),
	resolve: require => require.resolve("./PrivacyPolicy.svelte")
});
