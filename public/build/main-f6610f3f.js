...
// (24:2) <Route path="/privacy-policy" let:params>
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(24:2) <Route path=\\\"/privacy-policy\\\" let:params>",
		ctx
	});
...
// (27:2) <Route path="/terms-of-service" let:params>
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(27:2) <Route path=\\\"/terms-of-service\\\" let:params>",
		ctx
	});
...
const Landing = register({
	loader: () => import('./Landing-b801afe0.js'),
	resolve: () => require.resolve("./Landing.svelte")
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-5dba71b9.js')
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-f69ae646.js')
});
