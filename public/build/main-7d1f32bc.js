...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "body svelte-1jbx7b3");
			add_location(div, file$1, 33, 2, 765);
		},
		m: function mount(target, anchor) {
...
const Landing = register({
	loader: () => import('./Landing-81235580.js'),
	resolve: () => import('./Landing-81235580.js')
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-52842022.js'),
	resolve: () => import('./TermsOfService-52842022.js')
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-90882629.js'),
	resolve: () => import('./PrivacyPolicy-90882629.js')
});
...
//# sourceMappingURL=main-7d1f32bc.js.map
