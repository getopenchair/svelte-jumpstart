...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", "body svelte-1j6z84w");
			add_location(div0, file$1, 31, 2, 708);
			add_location(p, file$1, 43, 4, 1023);
			add_location(div1, file$1, 42, 2, 1013);
		},
		m: function mount(target, anchor) {
...
const Landing = register({
	loader: () => import('./Landing-2bc9d809.js'),
	resolve: () => import('./Landing-2bc9d809.js')
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-1cbffbcb.js'),
	resolve: () => import('./TermsOfService-1cbffbcb.js')
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-59c9af01.js'),
	resolve: () => import('./PrivacyPolicy-59c9af01.js')
});
...
//# sourceMappingURL=main-c90de474.js.map
