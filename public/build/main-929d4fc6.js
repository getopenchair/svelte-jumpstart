...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 31, 2, 714);
			add_location(p, file$1, 43, 4, 1052);
			set_style(div1, "height", "100px");
			add_location(div1, file$1, 42, 2, 1019);
		},
		m: function mount(target, anchor) {
...
const Landing = register({
	loader: () => import('./Landing-a529ec3f.js'),
	resolve: () => import('./Landing-a529ec3f.js')
});

const TermsOfService = register({
	loader: () => import('./TermsOfService-9b0e8061.js'),
	resolve: () => import('./TermsOfService-9b0e8061.js')
});

const PrivacyPolicy = register({
	loader: () => import('./PrivacyPolicy-1dc95f80.js'),
	resolve: () => import('./PrivacyPolicy-1dc95f80.js')
});
...
//# sourceMappingURL=main-929d4fc6.js.map
